...
export async function addLogEntry(studentId, classId, { title, author, genre, dateStarted, isbn, cover, whyThisBook, interviewTechniques, priorKnowledge }) {
...
export async function addReadingStatus(classId, { studentId, logEntryId, title, page, date, note, enteredByName }) {
  return addDoc(collection(db, "readingStatus"), {
    classId, studentId, logEntryId, title, page, date,
    note: note || "", enteredByName: enteredByName || "",
