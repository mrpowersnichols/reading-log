...
export default function ReadingLogApp() {
  ...
  async function addBook({ title, author, genre, dateStarted, isbn, cover, whyThisBook, interviewTechniques, priorKnowledge }) {
    await addLogEntry(uid, CLASS_ID, { title, author, genre, dateStarted, isbn, cover, whyThisBook, interviewTechniques, priorKnowledge });
    setAddOpen(false);
  }
  ...
  return (
    <div className="rl-overlay" onClick={onClose}>
      <div className="rl-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <button className="rl-btn solid" style={{ width: "100%", justifyContent: "center" }} disabled={!title || !author} onClick={() => onSave({ title, author, genre, dateStarted, isbn, cover, whyThisBook, interviewTechniques, priorKnowledge })}>
...
function CloseBookModal({ mode, book, statusEntries, onClose, onSave }) {
  ...
  const mostRecentStatus = [...(statusEntries || [])].sort((a, b) => (a.date < b.date ? 1 : -1))[0];
